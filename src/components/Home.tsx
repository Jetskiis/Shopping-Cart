...
export const Home = () => {
  return (
    <div className="d-flex flex-row text-white p-3 m-5" id="homepage">
      ...
      <div className="d-flex flex-column justify-content-center align-items-center bg-info p-5">
        <h1 className="text-center mb-2 text-primary fw-bold fs-1">Welcome to the Electronics Store</h1>
        <p className="text-center m-5">
          <h2>The best way to buy the products you love.</h2>
        </p>
        <button className="btn btn-primary fs-5 fw-bold">
